...
import com.smartbox.investory.investment.infrastructure.integration.fx.FxDataPlugin;
import com.smartbox.investory.investment.infrastructure.integration.fx.FxQuote;
import com.smartbox.investory.investment.infrastructure.integration.fx.FxRequest;
...
public class CurrencyRateUpdaterService {
  ...
  @Autowired(required = false)
  private com.smartbox.investory.investment.accounting.InvestmentCalculationCache calculationCache;
    ...
    PluginConfig resolved =
        integrationConfigurationService == null
            ...
            : integrationConfigurationService.resolveForRuntime(
                com.smartbox.investory.investment.infrastructure.integration.IntegrationType
                    .FX_DATA,
