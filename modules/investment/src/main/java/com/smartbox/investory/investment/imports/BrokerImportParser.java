...
public interface BrokerImportParser extends IntegrationPlugin {
  ...
  @Override
  default com.smartbox.investory.investment.infrastructure.integration.ValidationResult validate(
      com.smartbox.investory.investment.infrastructure.integration.PluginConfig config) {
    return com.smartbox.investory.investment.infrastructure.integration.ValidationResult.success();
  }
}
