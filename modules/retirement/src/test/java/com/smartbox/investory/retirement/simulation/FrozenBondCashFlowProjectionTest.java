...
class FrozenBondCashFlowProjectionTest {
  ...
  void capitalizedYieldUsesPeriodActiveAtBaselineYear() {
    var profile = profile(assetWithPeriods(InterestTreatmentModel.CAPITALIZE,
  ...
  private static ProjectedLongTermAsset asset(
    ...
    return assetWithPeriods(treatment, taxRate, maturity, new ProjectedLongTermAsset.Period(
  ...
  private static ProjectedLongTermAsset assetWithPeriods(
      InterestTreatmentModel treatment, BigDecimal taxRate, LocalDate maturity,
  ...
  private static ProjectedLongTermAsset.Period period(
    ...
    return new ProjectedLongTermAsset.Period(
        LocalDate.parse(validFrom), validTo == null ? null : LocalDate.parse(validTo),
        annualIncome == null ? null : new BigDecimal(annualIncome), BigDecimal.ZERO,
