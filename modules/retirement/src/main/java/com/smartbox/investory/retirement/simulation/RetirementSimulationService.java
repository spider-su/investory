...
public class RetirementSimulationService implements RetirementSimulation {
  ...
  @Override
  public SimulationResult simulate(InvestmentProfile profile, SimulationAssumptions assumptions,
      SimulationScenario scenario, int baselineYear, SimulationCustomDeltas custom) {
    return simulateWithCustom(profile, assumptions, scenario, baselineYear, custom);
  }

  private SimulationResult simulateWithCustom(InvestmentProfile profile, SimulationAssumptions assumptions,
      SimulationScenario scenario, int baselineYear, SimulationCustomDeltas custom) {
    ...
    PlanningBuckets buckets = PlanningBuckets.fromProfileWithBondYield(profile,
        effective.equityReturnRate(), effective.capitalBondReturnRate());
  ...
  @Override
  public Map<SimulationScenario, SimulationResult> compareScenarios(InvestmentProfile profile,
      SimulationAssumptions assumptions, int baselineYear) {
  ...
  public Map<SimulationScenario, SimulationResult> compareScenarios(
    ...
    for (SimulationScenario scenario : SimulationScenario.values())
      results.put(scenario, simulateWithCustom(profile, assumptions, scenario, baselineYear, custom));
    return results;
  }
}
