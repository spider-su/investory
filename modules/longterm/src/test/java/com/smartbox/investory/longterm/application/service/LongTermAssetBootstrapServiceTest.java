...
@DisplayName("Long Term Asset Bootstrap Service")
class LongTermAssetBootstrapServiceTest {
  ...
  @DisplayName("sanitized Fixture Reconciles And Dry Run Does Not Write")
  @Test
  void sanitizedFixtureReconcilesAndDryRunDoesNotWrite() throws Exception {
    var document =
        new ObjectMapper()
            .readValue(
                Files.readString(exampleFixturePath()), LongTermAssetBootstrapDocument.class);
  ...
  private static Path exampleFixturePath() throws IOException {
    Path directory = Path.of("").toAbsolutePath();
    while (directory != null) {
      Path candidate =
          directory.resolve("app/src/main/resources/bootstrap/example-long-term-assets.json");
      if (Files.isRegularFile(candidate)) return candidate;
      directory = directory.getParent();
    }
    throw new IOException("Cannot locate example-long-term-assets.json from the test directory");
  }

  @DisplayName("existing External Key Is Updated And Second Dry Run Does Not Create Duplicate")
  @Test
  ...
  @DisplayName("repeated Import Upserts The Same Asset Without Duplicating It")
  @Test
  ...
  @DisplayName("bootstrap Schema Does Not Accept Credential Fields")
  @Test
  ...
  @DisplayName("invalid Input Fails Before Any Persistence")
  @Test
  ...
  @DisplayName("dry Run Rejects Missing Current Value And Deposit Maturity")
  @Test
  ...
  @DisplayName("bond Fixture Validates Maturity Rate And Treatment")
  @Test
  ...
  @DisplayName("dry Run Totals Use Only Cash Flows Effective On Asset Date")
  @Test
  ...
  @DisplayName("existing Asset Currency Cannot Be Relabeled By Bootstrap")
  @Test
  ...
  @DisplayName("bootstrap Correction Deletes Managed Contracts Before Writing Replacement Periods")
  @Test
  ...
  @DisplayName("empty Bootstrap Rental Input Deletes Stale Managed Contracts")
  @Test
  ...
  @DisplayName("anonymous Manual Contract Is Never Treated As Bootstrap Owned")
  @Test
