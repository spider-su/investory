...
--
-- Name: accounting_health_contribution_basis; Type: TABLE; Schema: investory; Owner: -
--
...
CREATE TABLE investory.accounting_health_contribution_basis (
    ...
    CONSTRAINT chk_accounting_health_basis_range CHECK (((valid_to IS NULL) OR (valid_to > valid_from))),
    CONSTRAINT chk_accounting_health_basis_value CHECK (((basis)::text = ANY ((ARRAY['YTD_REVENUE'::character varying, 'LOW'::character varying, 'MEDIUM'::character varying, 'HIGH'::character varying])::text[])))
);


--
-- Name: TABLE accounting_health_contribution_basis; Type: COMMENT; Schema: investory; Owner: -
--

COMMENT ON TABLE investory.accounting_health_contribution_basis IS 'Effective-dated, accounting-profile-scoped health contribution basis. It selects source inputs; it does not store calculated tax output.';


--
-- Name: accounting_health_contribution_basis_id_seq; Type: SEQUENCE; Schema: investory; Owner: -
--

CREATE SEQUENCE investory.accounting_health_contribution_basis_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: accounting_health_contribution_basis_id_seq; Type: SEQUENCE OWNED BY; Schema: investory; Owner: -
--

ALTER SEQUENCE investory.accounting_health_contribution_basis_id_seq OWNED BY investory.accounting_health_contribution_basis.id;
...
CREATE TABLE investory.accounting_poc_bank_transaction (
    ...
    source_row_identity character varying(128) NOT NULL
);
...
COMMENT ON COLUMN investory.accounting_poc_bank_transaction.external_transaction_id IS 'Provider transaction identifier when supplied; nullable because some bank exports omit it.';


--
-- Name: COLUMN accounting_poc_bank_transaction.source_row_identity; Type: COMMENT; Schema: investory; Owner: -
--

COMMENT ON COLUMN investory.accounting_poc_bank_transaction.source_row_identity IS 'Stable idempotency key: provider id when available, otherwise a deterministic hash of source fields.';
...
--
-- Name: accounting_health_contribution_basis id; Type: DEFAULT; Schema: investory; Owner: -
--

ALTER TABLE ONLY investory.accounting_health_contribution_basis ALTER COLUMN id SET DEFAULT nextval('investory.accounting_health_contribution_basis_id_seq'::regclass);
...
--
-- Data for Name: accounting_health_contribution_basis; Type: TABLE DATA; Schema: investory; Owner: -
--

COPY investory.accounting_health_contribution_basis (id, profile_id, valid_from, valid_to, basis) FROM stdin;
1	1	2026-01-01	\N	HIGH
\.
...
COPY investory.accounting_poc_bank_transaction (id, booking_date, related_period, reference, counterparty_alias, currency, amount, transaction_type, scope, note, external_transaction_id, source_row_identity) FROM stdin;
1	2026-07-03	2026-06-01	Service Agreements	CUSTOMER_EU_001	EUR	7636.0000	CUSTOMER_RECEIPT	BUSINESS	SEPA receipt for the prior monthly EU service; retained to prevent false July matching.	\N	1a418c8d6b4e4f6a5f784d60ab00da4e
2	2026-07-04	\N	Transfer of funds	OWN_ACCOUNT	EUR	-7636.0000	INTERNAL_TRANSFER	EXCLUDED_INTERNAL	Transfer between own accounts; never revenue or expense.	\N	b23ef535531541797ca9a5f226c224cd
3	2026-07-16	2026-06-01	FV 4/2026	CUSTOMER_PL_001	PLN	39864.3000	CUSTOMER_RECEIPT	BUSINESS	Exactly matches the corrected FV 4/2026 receivable.	\N	ef7be9376e09a9ad99f27c01f2e90a8e
4	2026-07-16	\N	Transfer of funds	OWN_ACCOUNT	PLN	-20000.0000	INTERNAL_TRANSFER	EXCLUDED_INTERNAL	Own-account transfer.	\N	a26ba71a5e3e2ff3a03f45dd65716be4
5	2026-08-05	2026-07-01	Service Agreements	CUSTOMER_EU_001	EUR	7636.0000	CUSTOMER_RECEIPT	BUSINESS	SEPA receipt matched to the July EU service fixture.	\N	05d809a04f59d6fca420db2fa091015a
6	2026-08-13	2026-07-01	FV 5/2026	CUSTOMER_PL_002	PLN	19987.5000	CUSTOMER_RECEIPT	BUSINESS	Payment received for FV 5/2026.	\N	21bbedc63e7ac861156f9a6eb4011e31
7	2026-08-18	2026-07-01	26M07 PPE business	TAX_OFFICE	PLN	-5791.0000	RYCZALT_PAYMENT	BUSINESS	Business ryczalt payment for 2026-07.	\N	f6ab210997c3f3beaa60126a1901d646
8	2026-08-18	2026-07-01	26M07 VAT-7	TAX_OFFICE	PLN	-3557.0000	VAT_PAYMENT	BUSINESS	VAT payment for 2026-07.	\N	e90ebf83ccbe280da026a93ff702d142
9	2026-08-18	2026-07-01	26M07 ZUS	ZUS	PLN	-1495.0000	ZUS_PAYMENT	BUSINESS	Bank payment for the 2026-07 ZUS obligation.	\N	46563ad65a51bf07ad9126ff8bf8859f
10	2026-08-18	2026-07-01	26M07 PPE rental	TAX_OFFICE	PLN	-740.0000	RENTAL_TAX_PAYMENT	EXCLUDED_PRIVATE	Private rental ryczalt; deliberately outside the business POC.	\N	b33651fcf7be882f12d63d1a01fa7c70
11	2026-08-18	\N	Transfer of funds	OWN_ACCOUNT	PLN	-8000.0000	INTERNAL_TRANSFER	EXCLUDED_INTERNAL	Own-account transfer.	\N	fe003dd22fbf9a8dded428ad0d71ef24
12	2026-02-13	2026-01-01	PDC-V1650-11	CUSTOMER_PL_001	PLN	36408.0000	CUSTOMER_RECEIPT	BUSINESS	Payment of January domestic invoice.	\N	a79ba2aed67902143ebe85921f3422aa
13	2026-03-13	2026-02-01	PDC-V1650-12	CUSTOMER_PL_001	PLN	36408.0000	CUSTOMER_RECEIPT	BUSINESS	Payment of February domestic invoice.	\N	47e5fd5cd60cf8dfdfa289dabc75c993
14	2026-04-14	2026-03-01	FV 1/2026	CUSTOMER_PL_001	PLN	40048.8000	CUSTOMER_RECEIPT	BUSINESS	Payment of March domestic invoice.	\N	0a71d77e35a4b5341cee1e439adc729f
15	2026-05-14	2026-04-01	FV 2/2026	CUSTOMER_PL_001	PLN	38228.4000	CUSTOMER_RECEIPT	BUSINESS	Payment of April domestic invoice.	\N	c70e0471cd607a82c71d23d2cdc8a998
16	2026-06-12	2026-05-01	FV 3/2026	CUSTOMER_PL_001	PLN	36408.0000	CUSTOMER_RECEIPT	BUSINESS	Payment of May domestic invoice.	\N	ac0abf921050ab2b7c393ab164d33c73
17	2026-03-05	2026-02-01	Service Agreements	CUSTOMER_EU_001	EUR	7636.0000	CUSTOMER_RECEIPT	BUSINESS	Receipt for February EU service.	\N	7241a24cf4c6ad875e18b63bb82fb564
18	2026-04-07	2026-03-01	Service Agreements	CUSTOMER_EU_001	EUR	7636.0000	CUSTOMER_RECEIPT	BUSINESS	Receipt for March EU service.	\N	141b41c436e7a64ad022bed3bd02b730
19	2026-05-06	2026-04-01	Service Agreements	CUSTOMER_EU_001	EUR	7636.0000	CUSTOMER_RECEIPT	BUSINESS	Receipt for April EU service.	\N	7a4ecbca2ab09f018f17c81fdf1da3bc
20	2026-06-05	2026-05-01	Service Agreements	CUSTOMER_EU_001	EUR	7636.0000	CUSTOMER_RECEIPT	BUSINESS	Receipt for May EU service.	\N	7416b4f04d6a70973721ced21ace773d
\.
...
--
-- Name: accounting_health_contribution_basis_id_seq; Type: SEQUENCE SET; Schema: investory; Owner: -
--

SELECT pg_catalog.setval('investory.accounting_health_contribution_basis_id_seq', 1, true);
...
--
-- Name: accounting_health_contribution_basis accounting_health_contribution_basis_pkey; Type: CONSTRAINT; Schema: investory; Owner: -
--

ALTER TABLE ONLY investory.accounting_health_contribution_basis
    ADD CONSTRAINT accounting_health_contribution_basis_pkey PRIMARY KEY (id);


--
-- Name: accounting_health_contribution_basis accounting_health_contribution_basis_profile_id_valid_from_key; Type: CONSTRAINT; Schema: investory; Owner: -
--

ALTER TABLE ONLY investory.accounting_health_contribution_basis
    ADD CONSTRAINT accounting_health_contribution_basis_profile_id_valid_from_key UNIQUE (profile_id, valid_from);
...
--
-- Name: idx_accounting_health_basis_lookup; Type: INDEX; Schema: investory; Owner: -
--

CREATE INDEX idx_accounting_health_basis_lookup ON investory.accounting_health_contribution_basis USING btree (profile_id, valid_from DESC);
...
--
-- Name: uq_accounting_poc_bank_source_identity; Type: INDEX; Schema: investory; Owner: -
--

CREATE UNIQUE INDEX uq_accounting_poc_bank_source_identity ON investory.accounting_poc_bank_transaction USING btree (source_row_identity);


--
-- Name: accounting_poc_bank_transaction trg_accounting_poc_bank_source_identity; Type: TRIGGER; Schema: investory; Owner: -
--

CREATE TRIGGER trg_accounting_poc_bank_source_identity BEFORE INSERT OR UPDATE OF external_transaction_id, booking_date, related_period, reference, counterparty_alias, currency, amount, transaction_type, scope, note ON investory.accounting_poc_bank_transaction FOR EACH ROW EXECUTE FUNCTION investory.accounting_poc_bank_source_identity();


--
-- Name: accounting_health_contribution_basis accounting_health_contribution_basis_profile_id_fkey; Type: FK CONSTRAINT; Schema: investory; Owner: -
--

ALTER TABLE ONLY investory.accounting_health_contribution_basis
    ADD CONSTRAINT accounting_health_contribution_basis_profile_id_fkey FOREIGN KEY (profile_id) REFERENCES investory.accounting_poc_profile(id);
