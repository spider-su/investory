...
-- Source: accounting POC tables and fixtures from the squashed app/src/main/resources/sql/migration/V01.010__accounting_poc_facts.sql.
--
...
--
-- Name: accounting_poc_bank_transaction accounting_poc_bank_transaction_source_id_fkey; Type: FK CONSTRAINT; Schema: investory; Owner: -
--

ALTER TABLE ONLY investory.accounting_poc_bank_transaction
    ADD CONSTRAINT accounting_poc_bank_transaction_source_id_fkey FOREIGN KEY (source_id) REFERENCES investory.accounting_source_evidence(id);
