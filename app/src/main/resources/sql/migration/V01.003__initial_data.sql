...
INSERT INTO accounts (id, external_account_id, currency, provider, name, owner, portfolio_id, cash_only) VALUES
    ('90000003', '90000003', 'PLN', 'XTB', 'Sample PLN Account', 'Sample User', 1, false),
    ('90000004', '90000004', 'USD', 'XTB', 'Sample USD Account', 'Sample User', 1, false),
    ('90000005', '90000005', 'EUR', 'XTB', 'Sample EUR Account', 'Sample User', 1, true),
    ('90000006', '90000006', 'USD', 'XTB', 'Sample Metals Account', 'Sample User', 1, false),
    ('90000007', '90000007', 'PLN', 'XTB', 'Sample Retirement Account', 'Sample User', 1, false),
    ('90000008', '90000008', 'PLN', 'XTB', 'Sample PLN Cash Account', 'Sample User', 1, true),
    ('90000002', '90000002', 'USD', 'XTB', 'Sample USD Trading Account', 'Sample User', 1, false),
    ('90000009', '90000009', 'EUR', 'XTB', 'Sample EUR Cash Account', 'Sample User', 1, true),
    ('90000010', '90000010', 'USD', 'XTB', 'Sample Income Account', 'Sample User', 1, false),
    ('90000011', '90000011', 'PLN', 'XTB', 'Sample PLN Reserve Account', 'Sample User', 1, true),
    ('90000001', '90000001', 'USD', 'IBKR', 'Sample IBKR Account', 'Sample User', 1, false),
    ('91000003', '90000003', 'PLN', 'XTB', 'XTB PLN investment account', 'Happy Investor', 2, false),
    ('91000005', '90000004', 'USD', 'XTB', 'XTB USD reserve account', 'Happy Investor', 2, false),
    ('91000006', '90000005', 'EUR', 'XTB', 'XTB EUR cash account', 'Happy Investor', 2, true),
    ('91000007', '90000006', 'USD', 'XTB', 'XTB metals account', 'Happy Investor', 2, false),
    ('91000008', '90000007', 'PLN', 'XTB', 'XTB retirement account', 'Happy Investor', 2, false),
    ('91000009', '90000008', 'PLN', 'XTB', 'XTB cash account', 'Happy Investor', 2, true),
    ('91000002', '90000002', 'USD', 'XTB', 'XTB USD investment account', 'Happy Investor', 2, false),
    ('91000004', '90000009', 'EUR', 'XTB', 'XTB EUR reserve account', 'Happy Investor', 2, true),
    ('91000010', '90000010', 'USD', 'XTB', 'XTB income account', 'Happy Investor', 2, false),
    ('91000011', '90000011', 'PLN', 'XTB', 'XTB PLN reserve account', 'Happy Investor', 2, true),
