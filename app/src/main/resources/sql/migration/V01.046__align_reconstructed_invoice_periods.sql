-- Rebuild the reconstruction using the canonical Ryczalt period assignment.
-- This preserves correction allocation instead of deriving the month from issue/accounting dates.
