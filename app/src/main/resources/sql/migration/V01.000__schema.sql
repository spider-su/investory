...
VALUES
    ...
    ('reconciliation_fallback_unrealized_absolute_tolerance', 100, 'C6 fallback unrealized-profit absolute tolerance.'),
    ('reconciliation_market_value_absolute_tolerance', 400, 'Absolute tolerance for daily account market-value reconciliation.'),
    ('reconciliation_market_value_relative_tolerance', 0.02, 'Relative tolerance for daily account market-value reconciliation.'),
    ('reconciliation_cash_absolute_tolerance', 5, 'Absolute tolerance for daily account cash reconciliation.'),
...
-- Canonical daily neutral FX rates. This table was previously introduced by
-- V01.011 and is kept with the schema objects for fresh databases.
