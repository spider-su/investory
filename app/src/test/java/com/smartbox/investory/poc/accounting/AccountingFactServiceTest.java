...
class AccountingFactServiceTest {
  ...
  void reconstructsCleanFebruaryVatFromExpenseDocuments() {
    ...
    InvoiceRow domestic =
        invoice(february, LocalDate.of(2026, 2, 28), null, "PDC-V1650-12", "CUSTOMER_PL_001", "PLN",
            "29600.00", "6808.00", "36408.00", "0", "0", "0", "36408.00", "29600.00");
    InvoiceRow eu =
        invoice(february, LocalDate.of(2026, 2, 28), LocalDate.of(2026, 2, 27), "EU-SERVICE-2026-02",
            "CUSTOMER_EU_001", "EUR", "7636.00", "0", "7636.00", "0", "0", "0", "7636.00", "32249.12");

    when(repository.invoicesForPeriod(february)).thenReturn(List.of(domestic, eu));
    when(repository.expensesForPeriod(february))
        .thenReturn(List.of(expense("ACCOUNTING", "68.54", "1.00", "68.54"), expense("FUEL", "64.01", "0.50", "32.01")));
  ...
  private InvoiceRow invoice(
      LocalDate period, LocalDate saleDate, LocalDate fxRateDate, String reference, String customer,
      String currency, String net, String vat, String gross, String correctionNet, String correctionVat,
      String correctionGross, String expectedReceivable, String bookedNetPln) {
  ...
  private ExpenseRow expense(String reference, String vat, String ratio, String deductible) {
    return new ExpenseRow(
        1L, LocalDate.of(2026, 2, 1), null, reference, "SUPPLIER", "CATEGORY", "PLN",
        BigDecimal.ZERO, new BigDecimal(vat), BigDecimal.ZERO, new BigDecimal(ratio),
        new BigDecimal(deductible), "SOURCE_DOCUMENT", "fixture");
  }

  private BankRow bank(
      LocalDate bookingDate, LocalDate relatedPeriod, String reference, String customer, String currency, String amount) {
    return new BankRow(
