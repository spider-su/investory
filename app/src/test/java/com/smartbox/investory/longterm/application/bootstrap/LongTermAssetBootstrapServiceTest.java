...
class LongTermAssetBootstrapServiceTest {
  ...
  void bondFixtureValidatesMaturityRateAndTreatment() {
    ...
    var input =
        new LongTermAssetBootstrapDocument.Asset(
            "bond-2030",
  ...
  private static LongTermAsset asset(String key, String value) {
    var asset = new LongTermAsset();
    asset.setId(1L);
  ...
  private static LongTermAssetBootstrapDocument.Asset assetInput(
      String key, LongTermAssetType type, String value) {
    return new LongTermAssetBootstrapDocument.Asset(
        key,
        type,
        key,
        CurrencyType.PLN,
