...
class AuthRestControllerTest {
  ...
  void webLoginSetsHttpOnlyCookieAndDoesNotReturnBearerToken() {
    ...
    when(manager.authenticate(org.mockito.ArgumentMatchers.any(UsernamePasswordAuthenticationToken.class)))
    ...
    var result = controller.login(new AuthRestController.LoginRequest(null, "web-user", "password"), "web", response);
