...
class XtbAccountFundingCalculatorTest {
  ...
  void nonXtbAndNonUsdAccountsAreUnaffected() {
    ...
    assertEquals(
        Map.of(),
        calculator.calculate(
            List.of(operation, pair, eurOperation, eurPair),
            Map.of(100L, ibkr, 200L, xtbEur)));
  }
  ...
  private static CashOperation transfer(
