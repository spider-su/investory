...
public final class PortfolioTestData {
  ...
  public static final AccountDefinition IBKR_USD =
      new AccountDefinition(IBKR_USD_ACCOUNT_ID, "IBKR USD", CurrencyType.USD, "Interactive Brokers");
  ...
  public static final AccountDefinition CRYPTO_USD =
      new AccountDefinition(CRYPTO_USD_ACCOUNT_ID, "Crypto USD", CurrencyType.USD, "Crypto Exchange");

  public static final AssetDefinition AAPL =
      new AssetDefinition("AAPL.US", "AAPL", "AAPL", "AAPL", "United States", CurrencyType.USD, "STOCK");
  public static final AssetDefinition MSFT =
      new AssetDefinition("MSFT.US", "MSFT", "MSFT", "MSFT", "United States", CurrencyType.USD, "STOCK");
  public static final AssetDefinition TSLA =
      new AssetDefinition("TSLA.US", "TSLA", "TSLA", "TSLA", "United States", CurrencyType.USD, "STOCK");
  ...
  public static final AssetDefinition IWDA_AS =
      new AssetDefinition("IWDA.NL", "IWDA", "IWDA", "IWDA.AS", "Netherlands", CurrencyType.EUR, "ETF");
  public static final AssetDefinition US_TREASURY_2028 =
      new AssetDefinition("UST2028.US", "UST2028", "UST2028", "UST2028", "United States", CurrencyType.USD, "BOND");
  public static final AssetDefinition POLISH_TREASURY_2027 =
      new AssetDefinition("PLTB2027.PL", "PLTB2027", "PLTB2027", "PLTB2027", "Poland", CurrencyType.PLN, "BOND");
  public static final AssetDefinition AAPL_CALL_2026 =
      new AssetDefinition("AAPL260116C00180000", "AAPL", "AAPL", "AAPL260116C00180000", "United States", CurrencyType.USD, "OPTION");
  public static final AssetDefinition SPY_PUT_2026 =
      new AssetDefinition("SPY260116P00400000", "SPY", "SPY", "SPY260116P00400000", "United States", CurrencyType.USD, "OPTION");
  ...
  public static final Map<LocalDate, Double> AAPL_PRICES_USD =
      Map.of(
          AAPL_FIRST_BUY_DATE, 180.00,
          JANUARY_MONTH_END, 190.00,
          AAPL_SECOND_BUY_DATE, 200.00,
          FEBRUARY_MONTH_END, 210.00,
          AAPL_PARTIAL_SALE_DATE, 220.00,
          YEAR_END, 230.00,
          LocalDate.of(2026, 2, 10), 210.00);
