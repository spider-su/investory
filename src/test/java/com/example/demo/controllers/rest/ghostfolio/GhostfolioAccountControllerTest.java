...
class GhostfolioAccountControllerTest {
  ...
  void returnsCompleteGhostfolioAccountWithValueEnvelope() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(jsonPath("$.accounts[0].balanceInBaseCurrency").value(16_239.61335696))
        .andExpect(jsonPath("$.accounts[0].value").value(51_927.00335696))
        .andExpect(jsonPath("$.accounts[0].valueInBaseCurrency").value(51_927.00335696))
        ...
        .andExpect(jsonPath("$.accounts[0].allocationInPercentage").value(0.3287089087898905d))
        .andExpect(jsonPath("$.activitiesCount").value(0))
