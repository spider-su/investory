  ...
  void returnsGhostfolioPortfolioDetailsContract() throws Exception {
    when(compatibilityService.details(null, null))
        .thenReturn(
            Map.of(
                "accounts",
                    Map.of("1", Map.of("name", "Broker USD", "valueInBaseCurrency", 10000.0d)),
                "holdings",
                    Map.of(
                        "AAPL.US",
                        Map.of(
                ...
                "platforms", Map.of("1", Map.of("valueInBaseCurrency", 10000.0d)),
                "summary",
                    Map.of(
    ...
    mockMvc
        ...
        .andExpect(jsonPath("$.holdings['AAPL.US'].assetProfile.name").value("AAPL.US"))
        .andExpect(jsonPath("$.holdings['AAPL.US'].valueInBaseCurrency").value(8000.0))
