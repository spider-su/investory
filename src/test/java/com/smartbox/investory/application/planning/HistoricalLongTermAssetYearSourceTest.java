...
class HistoricalLongTermAssetYearSourceTest {
  private final LongTermAssetService longTermAssets = mock(LongTermAssetService.class);
  ...
  void derivesAnnualNetRentalIncomeFromApplicableEconomics() {
    when(longTermAssets.historicalAnnualSnapshot(7L, 2025))
        .thenReturn(
            new com.smartbox.investory.application.longterm.LongTermAssetAnnualSnapshot(
