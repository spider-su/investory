...
public class OpenAiChatService {
    ...
    public OpenAiChatService(
            ...
            @Value("${app.openai.instructions:You are the Investory assistant. Give concise, factual answers about investing and portfolio management. Do not claim access to portfolio data unless it was included in the user's message. State uncertainty clearly. Do not provide personalized financial guarantees.}")
                    String instructions,
    ...
    public String reply(String chatId, String userMessage) {
        ...
        String input = buildInput(normalizedMessage, portfolioContextService.loadIfRelevant(normalizedMessage));
