...
public class PortfolioContextService {
    ...
    private static final List<String> PORTFOLIO_TERMS = List.of(
            "portfolio", "balance", "cash", "account", "position", "positions",
            "holding", "holdings", "profit", "loss", "p/l", "roi", "return",
            "performance", "dividend", "allocation", "exposure", "currency",
            "broker", "worth", "invested", "realized", "unrealized", "analysis",
            "analyze", "review", "monthly", "quarterly", "annual", "yearly",
            "risk", "concentration", "diversification", "rebalance", "rebalancing",
            "strategy", "withdrawal", "drawdown", "benchmark", "stress");
