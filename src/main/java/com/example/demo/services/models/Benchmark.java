...
/**
 * Comparison of account monthly P/L against SPY performance from the same starting value, expressed
 * as cumulative USD P/L over time plus simple excess return in percentage points.
 */
@Data
