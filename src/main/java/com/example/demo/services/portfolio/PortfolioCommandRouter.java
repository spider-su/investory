...
public class PortfolioCommandRouter {
    ...
    static PortfolioCommand parse(String message, String botUsername) {
        ...
        return switch (normalized) {
            ...
            case "/pnl", "/profit", "show profit", "show pnl", "show p/l" ->
                    PortfolioCommand.PNL;
            ...
            case "/dividends", "show dividends", "how much dividends" ->
                    PortfolioCommand.DIVIDENDS;
            case "/allocation", "show allocation", "portfolio allocation" ->
                    PortfolioCommand.ALLOCATION;
    ...
    private static String normalizeCommand(String message, String botUsername) {
        ...
        if (normalized.startsWith("/") && botUsername != null && !botUsername.isBlank()) {
            normalized = normalized.replace(
                    "@" + botUsername.trim().toLowerCase(Locale.ROOT), "");
        }
        return normalized;
    }
}
