...
public class PortfolioCurrencyBreakdown {
  ...
  public Double getAmountLocal() { return amountLocal == null ? null : amountLocal.doubleValue(); }
  public Double getAmountInBaseCurrency() { return amountInBaseCurrency == null ? null : amountInBaseCurrency.doubleValue(); }

  public PortfolioCurrencyBreakdown(
      Long portfolioId,
