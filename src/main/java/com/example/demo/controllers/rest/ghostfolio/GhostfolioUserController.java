 ...
 *
 * <p>The frontend needs a user and settings object before it will enter authenticated routes.
 * This adapter represents the single local Investory user and does not create a second user store.
 */
@RestController
