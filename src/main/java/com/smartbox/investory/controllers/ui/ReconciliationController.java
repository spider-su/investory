...
import com.smartbox.investory.services.reconciliation.ReconciliationMode;
import com.smartbox.investory.services.reconciliation.ReconciliationReportService;
  ...
  public String reconciliation(
    ...
    var report =
        mode == ReconciliationMode.QUICK && asOf == null
            ...
            : reconciliationReportService.load(
                new com.smartbox.investory.services.reconciliation.ReconciliationContext(
