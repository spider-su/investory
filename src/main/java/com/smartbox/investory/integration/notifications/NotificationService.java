...
/**
 * Aggregates and dispatches Telegram notifications: - {@link #sendDailyDigest()} pushes a snapshot
 * summary after the market-close job. - {@link #runAlerts()} evaluates every {@link AlertRule} and
 * sends only fired ones.
 *
 * <p>Telegram is optional: when {@code app.telegram.enabled=false} the {@link PortfolioBot} bean is
 * absent and messages are logged instead of being sent.
 */
@Slf4j
@Service
