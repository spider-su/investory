...
import com.smartbox.investory.controllers.ui.UiPresentation;
...
public class RetirementSimulationController {
  ...
  public String simulation(
    ...
    var assumptions =
        new SimulationAssumptions(
            ...
            percentInputToRate(cashReturn, base.cashReturnRate()),
            percentInputToRate(fixedIncomeReturn, base.fixedIncomeReturnRate()),
            percentInputToRate(equityReturn, base.equityReturnRate()),
            percentInputToRate(realEstateReturn, base.realEstateReturnRate()),
            percentInputToRate(otherReturn, base.otherReturnRate()),
  ...
  public String savePlan(
      ...
      @RequestParam BigDecimal cashReturn,
      @RequestParam BigDecimal fixedIncomeReturn,
      @RequestParam BigDecimal equityReturn,
      @RequestParam(required = false) BigDecimal realEstateReturn,
      @RequestParam BigDecimal otherReturn,
      @RequestParam(required = false) Integer pensionStartAge,
      @RequestParam BigDecimal annualPension,
      @RequestParam BigDecimal capitalGainTaxRate,
      @RequestParam(defaultValue = "PLN") CurrencyType planningDisplayCurrency,
