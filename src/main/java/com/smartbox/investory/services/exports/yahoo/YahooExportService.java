package com.smartbox.investory.services.exports.yahoo;
...
import com.smartbox.investory.infrastructure.repository.YahooExportState;
import com.smartbox.investory.infrastructure.repository.YahooExportStateRepository;
...
public class YahooExportService {
  ...
  public YahooExportService(
    ...
    this(openedPositionRepository, accountStatisticsRepository, accountsCsv, null);
  }
  ...
  public YahooExportStatus status() {
    if (exportStateRepository == null) return new YahooExportStatus(null, false);
    ...
    return exportStateRepository
        ...
        .map(
            state -> {
              ...
              return new YahooExportStatus(state.getExportedAt(), currentState);
            })
        .orElseGet(() -> new YahooExportStatus(null, false));
  }
  ...
  public record YahooExportStatus(ZonedDateTime lastExport, boolean upToDate) {}
