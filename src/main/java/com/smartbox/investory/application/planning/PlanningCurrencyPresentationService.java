...
public class PlanningCurrencyPresentationService {
  ...
  public SustainableSpendingAnalysisMoney displaySustainableSpending(
      com.smartbox.investory.application.simulation.SustainableSpendingAnalysis analysis,
      CurrencyType display) {
    ...
    if (base.state()
            == com.smartbox.investory.application.simulation.SustainableSpendingResultState
  ...
  private static String spendingLimit(
      com.smartbox.investory.application.simulation.SustainableSpendingAnalysis.ScenarioResult
          result,
      BigDecimal value) {
  ...
  public SimulationSensitivityAnalysisMoney displaySensitivity(
      com.smartbox.investory.application.simulation.SimulationSensitivityAnalysis analysis,
      CurrencyType display) {
            ...
            .filter(
                result ->
                    result.driver().category()
                        == com.smartbox.investory.application.simulation.SensitivityDriverCategory
                            .RISK)
            .toList();
    var leverResults =
        analysis.drivers().stream()
  ...
  public PlanningFlexibilityMoney displayPlanningFlexibility(
      com.smartbox.investory.application.simulation.SustainableSpendingAnalysis spending,
  ...
  private SimulationSensitivityAnalysisMoney.Driver displaySensitivityResult(
      com.smartbox.investory.application.simulation.SimulationSensitivityResult result,
      CurrencyType display) {
  ...
  private static String reserveCoverageDisplay(
      com.smartbox.investory.application.simulation.PlanSustainabilityAssessment assessment) {
  ...
  private static String riskInterpretation(
      com.smartbox.investory.application.simulation.SimulationSensitivityAnalysis analysis,
      java.util.List<com.smartbox.investory.application.simulation.SimulationSensitivityResult>
          risks) {
    ...
    if (risks.stream()
        .allMatch(
            result ->
                result.impact()
                    == com.smartbox.investory.application.simulation.SensitivityImpact.NEGLIGIBLE))
    ...
    if (top.impact() == com.smartbox.investory.application.simulation.SensitivityImpact.CRITICAL)
