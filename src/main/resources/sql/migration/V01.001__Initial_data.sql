insert into portfolios (name, base_currency, owner) values
    ('Alex & Olga Portfolio', 'USD', 'Alex & Olga Kotik')
on conflict do nothing;

insert into accounts (id, currency, provider, name, owner, portfolio_id) values
    ('51551301', 'PLN', 'XTB', 'IKE Alex',  'Alex Kotik', 1),
    ('51822121', 'USD', 'XTB', 'Trading USD',   'Olga Kotik', 1),
    ('51747407', 'EUR', 'XTB', 'Trading EUR',   'Olga Kotik', 1),
    ('53582946', 'USD', 'XTB', 'Trading USD Metal',   'Olga Kotik', 1),
    ('51729109', 'PLN', 'XTB', 'IKE Olga',  'Olga Kotik', 1),
    ('50290466', 'PLN', 'XTB', 'Trading PLN',   'Alex Kotik', 1),
    ...
    ('51707603', 'PLN', 'XTB', 'Trading PLN',  'Olga Kotik', 1),
    ('17959259', 'USD', 'IBKR', 'IBKR', 'Alex Kotik', 1)
on conflict (id) do nothing;

insert into exchange_rates (month, base, to_currency, rate) values
...
insert into assets (name, symbol, ticker, ibkr, yahoo, country, currency, asset_type, active)
values
    ...
    ('Agree Realty Corporation', 'ADC.US', 'ADC', 'ADC', 'ADC.US', 'US', 'USD', 'EQUITY', false),
    ...
    ('American Tower Corporation', 'AMT.US', 'AMT', 'AMT', 'AMT.US', 'US', 'USD', 'EQUITY', false),
    ...
    ('Ares Capital Corporation', 'ARCC.US', 'ARCC', 'ARCC', 'ARCC.US', 'US', 'USD', 'EQUITY', false),
    ('Alexandria Real Estate Equities, Inc.', 'ARE.US', 'ARE', 'ARE', 'ARE.US', 'US', 'USD', 'EQUITY', false),
    ...
    ('BITCOIN', 'BITCOIN', 'BITCOIN', 'BITCOIN', 'BITCOIN', 'US', 'USD', 'EQUITY', false),
    ...
    ('COCOA', 'COCOA', 'COCOA', 'COCOA', 'COCOA', 'US', 'USD', 'EQUITY', false),
    ...
    ('Digital Realty Trust, Inc.', 'DLR.US', 'DLR', 'DLR', 'DLR.US', 'US', 'USD', 'EQUITY', false),
    ('Dollar Tree, Inc.', 'DLTR.US', 'DLTR', 'DLTR', 'DLTR.US', 'US', 'USD', 'EQUITY', false),
    ('Dino Polska S.A.', 'DNP.PL', 'DNP', 'DNP', 'DNP.PL', 'PL', 'PLN', 'EQUITY', false),
    ('DOGECOIN', 'DOGECOIN', 'DOGECOIN', 'DOGECOIN', 'DOGECOIN', 'US', 'USD', 'EQUITY', false),
    ...
    ('Equinix, Inc.', 'EQIX.US', 'EQIX', 'EQIX', 'EQIX.US', 'US', 'USD', 'EQUITY', false),
    ...
    ('ETHEREUM', 'ETHEREUM', 'ETHEREUM', 'ETHEREUM', 'ETHEREUM', 'US', 'USD', 'EQUITY', false),
    ...
    ('NOVOB', 'NOVOB.DK', 'NOVOB', 'NOVOB', 'NOVOB.DK', 'DK', 'EUR', 'EQUITY', false),
...
-- Prevent future ticker duplicates
CREATE UNIQUE INDEX IF NOT EXISTS ux_assets_ticker ON assets(ticker);
