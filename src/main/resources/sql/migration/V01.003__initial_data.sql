...
insert into accounts (id, external_account_id, currency, provider, name, owner, portfolio_id, cash_only) values
    ('51551301', '51551301', 'PLN', 'XTB', 'IKE A',  'Aaaa', 1, false),
    ('51822121', '51822121', 'USD', 'XTB', 'REITs USD',   'Ooo', 1, false),
    ('51747407', '51747407', 'EUR', 'XTB', 'EUR - Empty',   'Ooo', 1, true),
    ('53582946', '53582946', 'USD', 'XTB', 'Trading USD Metal',   'Ooo', 1, false),
    ('51729109', '51729109', 'PLN', 'XTB', 'IKE O',  'Ooo', 1, false),
    ('50290466', '50290466', 'PLN', 'XTB', 'PLN - Empty',   'Aaaa', 1, true),
    ('51499241', '51499241', 'USD', 'XTB', 'Trading USD',   'Aaaa', 1, false),
    ('51548444', '51548444', 'EUR', 'XTB', 'Trading EUR',   'Aaaa', 1, true),
    ('51993106', '51993106', 'USD', 'XTB', 'Dividends', 'Aaaa', 1, false),
    ('51707603', '51707603', 'PLN', 'XTB', 'PLN - Empty',  'Ooo', 1, true),
    ('17959259', '17959259', 'USD', 'IBKR', 'IBKR', 'AaaaOoo', 1, false);
